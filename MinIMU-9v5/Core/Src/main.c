...
main (void)
{
  ...
  while (1)
      ...
      if (dcmData.timer > dcmData.timer_old)
	{
	  ...
	  dcmData.matrixData.G_Dt = ((float) (dcmData.timer - dcmData.timer_old)
	      / 1000);
      ...
      else
	{
      ...
      sprintf (buffer, "\033[27\033[HEuler:\n\r"
	       ...
	       "\tY:\t\t%d\n\r"
	       "\tZ:\t\t%d\n",
	       ToDeg(dcmData.angleData.roll), ToDeg(dcmData.angleData.pitch),
	       ToDeg(dcmData.angleData.yaw), dcmData.sensorData.gyro_x,
	       dcmData.sensorData.gyro_y, dcmData.sensorData.gyro_z,
	       dcmData.sensorData.accl_x, dcmData.sensorData.accl_y,
